...
/// URL of model assuming it was installed in the same bundle as this class
    class var urlOfModelInThisBundle : URL {
        ...
        return bundle.url(forResource: "pictionairy", withExtension:"mlmodelc")!
    }
    ...
    */
    @available(macOS 10.14, iOS 12.0, tvOS 12.0, watchOS 5.0, *)
    func predictions(inputs: [pictionairyInput], options: MLPredictionOptions = MLPredictionOptions()) throws -> [pictionairyOutput] {
